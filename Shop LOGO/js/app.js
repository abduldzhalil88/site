...
searchPageSelect.addEventListener("click", function (e) {
    searchPageSelect.classList.toggle('_active');
...
for (let index = 0; index < checkboxCategories.length; index++) {
    ...
    checkboxCategory.addEventListener("change", function (e) {
        ...
        if (checkboxActiveCategories.length > 0) {
            ...
            let searchPageQuantity = document.querySelector('.search-page__quantity');
            searchPageQuantity.innerHTML = searchPageQuantity.getAttribute('data-text') + ' ' + checkboxActiveCategories.length;
        } else {
